...
function startStory(storyType) {
    ...
    if (!window._gingee_fort_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._gingee_fort_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._gingee_fort_story_options_html) {
        modalBody.innerHTML = window._gingee_fort_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('gingee-fort_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('gingee-fort_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('gingee-fort_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('gingee-fort_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Gingee Fort-specific quiz questions
let quizQuestions = [
    {
        question: "Gingee Fort is built on how many hills?",
        options: ["One", "Two", "Three", "Four"],
        correct: 2,
        explanation: "Gingee Fort is uniquely built on three hills: Rajagiri, Krishnagiri, and Chandrayandurg, connected by massive walls."
    },
    {
        question: "Who called Gingee Fort the 'Troy of the East'?",
        options: ["The British", "The French", "The Dutch", "The Portuguese"],
        correct: 0,
        explanation: "The British called it the 'Troy of the East' due to its impregnability and strategic importance."
    },
    {
        question: "Which Vijayanagara chieftain significantly expanded Gingee Fort?",
        options: ["Kurumbas", "Krishnadevaraya", "Tuluva Dynasty rulers", "Ananda Kon"],
        correct: 0,
        explanation: "The Kurumba chieftains under Vijayanagara expanded the fort significantly in the 13th-15th centuries."
    },
    {
        question: "Which Maratha leader captured Gingee Fort in the 17th century?",
        options: ["Shivaji Maharaj", "Santaji Ghorpade", "Shambhaji Maharaj", "Tukoji"],
        correct: 1,
        explanation: "Santaji Ghorpade, a Maratha general, captured Gingee Fort in 1677 and held it for several years."
    },
    {
        question: "The fort withstood a siege by Aurangzeb's forces for how many years?",
        options: ["3 years", "5 years", "7 years", "8 years"],
        correct: 3,
        explanation: "Gingee Fort heroically withstood an 8-year siege (1690-1698) by Aurangzeb's Mughal forces."
    },
    {
        question: "What is the height of the Rajagiri Hill at Gingee Fort?",
        options: ["600 feet", "800 feet", "1,000 feet", "1,200 feet"],
        correct: 1,
        explanation: "Rajagiri, the main hill, stands at approximately 800 feet and has the main fortifications."
    },
    {
        question: "How many gateways does the fort have in total?",
        options: ["5", "7", "9", "11"],
        correct: 1,
        explanation: "The fort complex has seven gateways, each strategically designed for defense against invaders."
    },
    {
        question: "What is unique about the Kalyana Mahal (marriage hall) in the fort?",
        options: ["Made of marble", "Has excellent acoustics", "100-pillared rectangular structure", "Underground location"],
        correct: 2,
        explanation: "The Kalyana Mahal is a magnificent 100-pillared rectangular structure showcasing Vijayanagara architecture."
    },
    {
        question: "Which famous temple is located within Gingee Fort?",
        options: ["Ranganatha Temple", "Venkataramana Temple", "Both A and B", "Virupaksha Temple"],
        correct: 2,
        explanation: "The fort houses both Ranganatha Temple and Venkataramana Temple, reflecting Vijayanagara religious traditions."
    },
    {
        question: "The fort's granary could store grain for how many years?",
        options: ["1 year", "2 years", "3 years", "5 years"],
        correct: 2,
        explanation: "The massive granaries were designed to store grain supplies for up to 3 years during sieges."
    },
    {
        question: "What is the circumference of the fort walls connecting the three hills?",
        options: ["5 km", "8 km", "11 km", "13 km"],
        correct: 3,
        explanation: "The massive fortification walls connecting the three hills stretch for approximately 13 kilometers."
    },
    {
        question: "Which architectural style predominantly influences Gingee Fort's structures?",
        options: ["Chola", "Pandya", "Vijayanagara", "Nayak"],
        correct: 2,
        explanation: "The fort primarily showcases Vijayanagara architectural style with later additions by Nayaks and Marathas."
    }
];
