...
function startStory(storyType) {
    ...
    if (!window._nilgiris_ooty_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._nilgiris_ooty_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._nilgiris_ooty_story_options_html) {
        modalBody.innerHTML = window._nilgiris_ooty_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('nilgiris-ooty_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('nilgiris-ooty_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('nilgiris-ooty_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('nilgiris-ooty_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Nilgiris-Ooty-specific quiz questions
let quizQuestions = [
    {
        question: "What is the literal meaning of 'Ooty' (Udhagamandalam)?",
        options: ["Queen of Hills", "Village of Huts", "Land of Lakes", "Mountain Paradise"],
        correct: 1,
        explanation: "Ooty's Tamil name 'Udhagamandalam' means 'village of huts', referring to the tribal settlements that originally existed here."
    },
    {
        question: "Which British official is credited with 'discovering' Ooty as a hill station?",
        options: ["John Sullivan", "Thomas Munro", "Arthur Wellesley", "Warren Hastings"],
        correct: 0,
        explanation: "John Sullivan, Collector of Coimbatore, discovered Ooty in 1819 and established it as a British summer retreat."
    },
    {
        question: "Which indigenous tribal community has historically inhabited the Nilgiris?",
        options: ["Irulas", "Todas, Kotas, Kurumbas, and Irulas", "Chenchus", "Lambadis"],
        correct: 1,
        explanation: "The Nilgiris is home to several indigenous communities: Todas, Kotas, Kurumbas, Irulas, Paniyans, and others."
    },
    {
        question: "What is the Nilgiri Mountain Railway famous for?",
        options: ["Fastest train", "UNESCO World Heritage Site", "Longest route", "Solar powered"],
        correct: 1,
        explanation: "The Nilgiri Mountain Railway (1908) is a UNESCO World Heritage Site and uses a unique rack and pinion system."
    },
    {
        question: "Ooty's Botanical Gardens were established in which year?",
        options: ["1820", "1847", "1860", "1875"],
        correct: 1,
        explanation: "The Government Botanical Garden was established in 1847 and spans 55 acres with over 650 plant species."
    },
    {
        question: "What is Ooty Lake's primary use when it was first created?",
        options: ["Drinking water", "Irrigation", "Recreation", "Fishing"],
        correct: 1,
        explanation: "Ooty Lake was created in 1825 by John Sullivan primarily for irrigation purposes, though now it's a major tourist attraction."
    },
    {
        question: "Which tree species was extensively planted in the Nilgiris and dominates the landscape?",
        options: ["Oak", "Eucalyptus", "Pine", "Cedar"],
        correct: 1,
        explanation: "Eucalyptus and wattle (acacia) trees were extensively planted by the British and now dominate the Nilgiri landscape."
    },
    {
        question: "What is the highest peak in the Nilgiris?",
        options: ["Ooty Peak", "Doddabetta", "Mukurthi Peak", "Snowdon Peak"],
        correct: 1,
        explanation: "Doddabetta Peak, at 2,637 meters (8,650 feet), is the highest point in the Nilgiris and South India's second-highest peak."
    },
    {
        question: "The Stone House in Ooty was built by whom?",
        options: ["Lord Elphinstone", "John Sullivan", "Lord Wenlock", "Thomas Munro"],
        correct: 1,
        explanation: "The Stone House, Ooty's first bungalow, was built by John Sullivan in 1822 and still stands as a heritage structure."
    },
    {
        question: "Ooty is famous for which agricultural product?",
        options: ["Coffee", "Tea", "Spices", "Cotton"],
        correct: 1,
        explanation: "Ooty is renowned for Nilgiri tea, grown in the surrounding hills and known for its distinctive fragrance and flavor."
    },
    {
        question: "Which British-era club in Ooty is one of India's oldest?",
        options: ["Gymkhana Club", "Ooty Club (est. 1830)", "Wellington Club", "Planters' Club"],
        correct: 1,
        explanation: "The Ooty Club, established in 1830, is one of India's oldest gentlemen's clubs and retains its colonial character."
    },
    {
        question: "What is unique about the Toda tribal huts (dogles)?",
        options: ["Made of bamboo", "Barrel-shaped with thatched roof", "Built on stilts", "Underground structures"],
        correct: 1,
        explanation: "Toda huts (dogles) are uniquely barrel-shaped with thatched roofs and small entrances, built without nails."
    }
];
