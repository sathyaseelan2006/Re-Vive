...
function startStory(storyType) {
    ...
    if (!window._rockfort_tiruchirappalli_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._rockfort_tiruchirappalli_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._rockfort_tiruchirappalli_story_options_html) {
        modalBody.innerHTML = window._rockfort_tiruchirappalli_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('rockfort-tiruchirappalli_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('rockfort-tiruchirappalli_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('rockfort-tiruchirappalli_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('rockfort-tiruchirappalli_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Rockfort Tiruchirappalli-specific quiz questions
let quizQuestions = [
    {
        question: "How old is the rock on which Rockfort is built?",
        options: ["500 million years", "1 billion years", "2 billion years", "3.8 billion years"],
        correct: 3,
        explanation: "The Rockfort is built on a 3.8 billion-year-old rock, making it one of the oldest rock formations on Earth."
    },
    {
        question: "How many steps lead to the Ucchi Pillayar Temple at the top of Rockfort?",
        options: ["344", "417", "520", "600"],
        correct: 1,
        explanation: "There are 417 steps carved into the rock leading to the Ucchi Pillayar (Ganesh) Temple at the summit."
    },
    {
        question: "What is the height of the Rockfort?",
        options: ["73 meters", "83 meters", "93 meters", "103 meters"],
        correct: 1,
        explanation: "The Rockfort stands at 83 meters (273 feet) above the surrounding plains, offering panoramic views of Trichy."
    },
    {
        question: "Which Nayak ruler constructed the fort and temples on the rock?",
        options: ["Vishwanatha Nayak", "Thirumalai Nayak", "Sevappa Nayak", "Achyutappa Nayak"],
        correct: 1,
        explanation: "Thirumalai Nayak (1623-1659) built the fort complex and the temples, though the rock was used earlier by Pallavas."
    },
    {
        question: "The Thayumanaswamy Temple halfway up the hill is dedicated to which deity?",
        options: ["Ganesha", "Shiva", "Vishnu", "Murugan"],
        correct: 1,
        explanation: "The Thayumanaswamy Temple, located halfway up, is dedicated to Lord Shiva and features Pallava-era rock-cut architecture."
    },
    {
        question: "Which ancient dynasty first used the rock as a fortification?",
        options: ["Cholas", "Pallavas", "Pandyas", "Nayaks"],
        correct: 1,
        explanation: "The Pallavas were the first to use the rock for fortification and carved cave temples in the 6th-7th centuries."
    },
    {
        question: "What historic battle was fought at Rockfort in 1751?",
        options: ["Battle of Plassey", "Carnatic Wars between British and French", "Battle of Wandiwash", "Battle of Buxar"],
        correct: 1,
        explanation: "During the Carnatic Wars, British and French forces fought for control of Rockfort in 1751-1752."
    },
    {
        question: "The Ucchi Pillayar Temple at the top is dedicated to which form of Ganesha?",
        options: ["Dancing Ganesha", "Vinayaka", "Ucchi Pillayar (Tall Ganesha)", "Heramba"],
        correct: 2,
        explanation: "Ucchi Pillayar means 'Ganesha at the top', and the temple houses a small 2-foot tall idol believed to be ancient."
    },
    {
        question: "From the top of Rockfort, which famous temple can be seen?",
        options: ["Meenakshi Temple", "Srirangam Ranganathaswamy Temple", "Brihadeeswarar Temple", "Kapaleeshwarar Temple"],
        correct: 1,
        explanation: "The view from Rockfort offers a spectacular panorama of Srirangam's Ranganathaswamy Temple and the city of Trichy."
    },
    {
        question: "What type of rock is the Rockfort made of?",
        options: ["Granite", "Sandstone", "Limestone", "Basalt"],
        correct: 0,
        explanation: "The Rockfort is made of hard metamorphic rock (charnockite), one of the oldest geological formations."
    },
    {
        question: "Which famous military commander used Rockfort as a strategic base?",
        options: ["Robert Clive", "Hyder Ali", "Tipu Sultan", "All of the above"],
        correct: 3,
        explanation: "The fort's strategic location made it important for various rulers including Hyder Ali, Tipu Sultan, and Robert Clive."
    },
    {
        question: "The rock-cut cave temple at Rockfort dates back to which period?",
        options: ["3rd century CE", "6th-7th century CE", "10th century CE", "13th century CE"],
        correct: 1,
        explanation: "The rock-cut cave temples were created by the Pallavas in the 6th-7th centuries CE, similar to Mahabalipuram."
    }
];
