...
function startStory(storyType) {
    ...
    if (!window._tiruvannamalai_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._tiruvannamalai_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._tiruvannamalai_story_options_html) {
        modalBody.innerHTML = window._tiruvannamalai_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('tiruvannamalai_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('tiruvannamalai_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('tiruvannamalai_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('tiruvannamalai_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Tiruvannamalai-specific quiz questions
let quizQuestions = [
    {
        question: "Tiruvannamalai's Arunachaleswarar Temple represents which element in the Pancha Bootha Sthalams?",
        options: ["Earth", "Water", "Fire (Agni)", "Air", "Space"],
        correct: 2,
        explanation: "Tiruvannamalai represents the Fire element (Agni), with Arunachala hill itself being the manifestation of Lord Shiva as a column of fire."
    },
    {
        question: "What is the spiritual practice of walking around Arunachala hill called?",
        options: ["Parikrama", "Girivalam (Pradakshina)", "Circumambulation", "Pada Yatra"],
        correct: 1,
        explanation: "Girivalam or Pradakshina is the sacred 14 km walk around Arunachala hill, especially auspicious during Purnima (full moon)."
    },
    {
        question: "Which sage-philosopher lived in Tiruvannamalai and is buried at the foot of Arunachala?",
        options: ["Adi Shankaracharya", "Ramana Maharshi", "Ramakrishna Paramahamsa", "Aurobindo"],
        correct: 1,
        explanation: "Ramana Maharshi lived in Tiruvannamalai from 1896 until his death in 1950, establishing it as a major spiritual center."
    },
    {
        question: "What is the height of the Arunachaleswarar Temple's Rajagopuram?",
        options: ["180 feet", "196 feet", "217 feet", "250 feet"],
        correct: 2,
        explanation: "The eastern Rajagopuram tower stands at 217 feet (11 storeys), making it one of the tallest temple towers in Tamil Nadu."
    },
    {
        question: "During which festival is a huge beacon lit atop Arunachala hill?",
        options: ["Mahashivaratri", "Karthigai Deepam", "Panguni Uthiram", "Arudra Darshan"],
        correct: 1,
        explanation: "During Karthigai Deepam (November-December), a massive beacon lit with tons of ghee is visible from miles away, symbolizing Shiva's column of fire."
    },
    {
        question: "How many prakarams (corridors) does the Arunachaleswarar Temple have?",
        options: ["Three", "Four", "Five", "Six"],
        correct: 1,
        explanation: "The temple has four concentric prakarams covering approximately 25 acres, with the outermost being the largest."
    },
    {
        question: "What is the approximate circumference of the Girivalam path around Arunachala?",
        options: ["10 km", "14 km", "18 km", "20 km"],
        correct: 1,
        explanation: "The Girivalam path is approximately 14 km long and takes 3-4 hours to complete, passing eight lingams (Ashtalingams)."
    },
    {
        question: "Which saint-poet composed the 'Arunachala Stuti Panchakam'?",
        options: ["Arunagirinathar", "Ramana Maharshi", "Appar", "Sundarar"],
        correct: 1,
        explanation: "Ramana Maharshi composed five hymns in praise of Arunachala, including 'Arunachala Shiva' and 'Arunachala Pancharatnam'."
    },
    {
        question: "What is the sacred tank in front of the Arunachaleswarar Temple called?",
        options: ["Shiva Theertham", "Agni Theertham", "Arunachala Theertham", "Maha Theertham"],
        correct: 0,
        explanation: "The Shiva Theertham (also called Sivaganga Tank) is the sacred tank where devotees take a ritual bath before entering the temple."
    },
    {
        question: "How many gopurams (towers) does the Arunachaleswarar Temple have?",
        options: ["Four", "Six", "Nine", "Twelve"],
        correct: 2,
        explanation: "The temple complex has nine magnificent gopurams, with the eastern Rajagopuram being the tallest."
    },
    {
        question: "According to legend, which two deities argued here, leading to the manifestation of the fire column?",
        options: ["Shiva and Vishnu", "Brahma and Vishnu", "Brahma and Shiva", "Shiva and Parvati"],
        correct: 1,
        explanation: "Brahma and Vishnu argued about supremacy, and Shiva manifested as an endless column of fire (Arunachala) to demonstrate his infinity."
    },
    {
        question: "The Arunachala hill is approximately how old geologically?",
        options: ["500 million years", "1 billion years", "2 billion years", "3.8 billion years"],
        correct: 3,
        explanation: "Arunachala hill is approximately 3.8 billion years old, making it one of the oldest rock formations on Earth."
    }
];
