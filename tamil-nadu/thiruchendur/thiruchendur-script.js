// Thiruchendur Heritage Site Interactive Features
// Sacred Seaside Temple - Consistent with Tamil Nadu heritage theme
...
const totalCards = 3; // Total number of heritage cards for Thiruchendur (seaside temple views)
...
function startStory(storyType) {
    ...
    if (!window._thiruchendur_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._thiruchendur_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._thiruchendur_story_options_html) {
        modalBody.innerHTML = window._thiruchendur_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('thiruchendur_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('thiruchendur_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('thiruchendur_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('thiruchendur_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Thiruchendur-specific quiz questions
let quizQuestions = [
    {
        question: "Thiruchendur Murugan Temple is one of the Six Abodes of Murugan. What are they called?",
        options: ["Aru Padai Veedu", "Mukti Sthalams", "Divya Desams", "Shakti Peethas"],
        correct: 0,
        explanation: "Thiruchendur is one of the Aru Padai Veedu (Six Battle Houses) of Lord Murugan, the six main temples dedicated to him."
    },
    {
        question: "What makes Thiruchendur Murugan Temple unique among the Aru Padai Veedu?",
        options: ["Highest temple", "Only sea-shore temple", "Largest temple", "Oldest temple"],
        correct: 1,
        explanation: "Thiruchendur is the only Aru Padai Veedu temple located on the seashore, directly adjacent to the Bay of Bengal."
    },
    {
        question: "According to legend, Murugan vanquished which demon king at Thiruchendur?",
        options: ["Ravana", "Surapadman", "Tarakasura", "Mahishasura"],
        correct: 1,
        explanation: "Lord Murugan defeated the demon king Surapadman at Thiruchendur, who was split into a peacock (vahana) and rooster (flag)."
    },
    {
        question: "Which saint-poet composed 'Thiruchendur Murugan Kovai' hymns?",
        options: ["Nakkirar", "Arunagirinathar", "Thirugnanasambandar", "Kachiyappa Sivachariyar"],
        correct: 1,
        explanation: "Arunagirinathar, the 15th-century Tamil poet-saint, composed Thiruppugazh hymns including the Thiruchendur Murugan Kovai."
    },
    {
        question: "How many steps lead down to the sea from the temple?",
        options: ["20", "30", "42", "50"],
        correct: 2,
        explanation: "There are 42 steps leading from the temple down to the sea, where devotees take holy dips in the Bay of Bengal."
    },
    {
        question: "The temple's Rajagopuram (main tower) faces which direction?",
        options: ["East (sea-facing)", "West", "North", "South"],
        correct: 0,
        explanation: "The 135-foot tall Rajagopuram faces east toward the Bay of Bengal, creating a spectacular view from the shore."
    },
    {
        question: "Which European colonial power controlled Thiruchendur for a period?",
        options: ["British", "French", "Dutch", "Portuguese"],
        correct: 2,
        explanation: "The Dutch East India Company controlled Thiruchendur in the 17th century and even used the temple as a fortress."
    },
    {
        question: "What was the temple converted into by the Dutch?",
        options: ["Trading post", "Military fortress", "Warehouse", "Hospital"],
        correct: 1,
        explanation: "During Dutch rule (1646-1648), the temple was fortified and used as a military fortress before being restored."
    },
    {
        question: "The temple has a unique mandapam called what?",
        options: ["1000-pillar mandapam", "Mela Mandapam (Upper Hall)", "Kalyana Mandapam", "Raja Mandapam"],
        correct: 1,
        explanation: "The Mela Mandapam (Upper Hall) is a unique elevated structure with beautiful corridors and sculptures."
    },
    {
        question: "According to legend, which Sanskrit work was composed at Thiruchendur?",
        options: ["Ramayana", "Mahabharata", "Skanda Purana", "Bhagavad Gita"],
        correct: 2,
        explanation: "Parts of the Skanda Purana, especially the Skanda Sashti Kavacham, are associated with Thiruchendur."
    },
    {
        question: "Which festival is most famously celebrated at Thiruchendur?",
        options: ["Panguni Uthiram", "Skanda Sashti", "Thai Poosam", "Vaikasi Visakam"],
        correct: 1,
        explanation: "Skanda Sashti, celebrating Murugan's victory over Surapadman, is the most important 6-day festival at Thiruchendur."
    },
    {
        question: "The deity at Thiruchendur is in which posture?",
        options: ["Standing", "Sitting", "Reclining", "Dancing"],
        correct: 0,
        explanation: "Lord Murugan appears in the standing posture (Nindra Kolam) facing east, with his consort Devasena."
    }
];
...
class HeritageGuideAI {
    constructor() {
        ...
        this.knowledgeBase = {
            context: `You are the Thiruchendur Heritage Guide AI, a passionate and knowledgeable expert guide specializing in Thiruchendur, the sacred seaside abode of Lord Murugan. You are the dedicated guardian of coastal temple heritage and divine wisdom. You should respond naturally to ANY question the user asks, while being especially enthusiastic about Thiruchendur's magnificent spiritual heritage.

CORE PERSONALITY:
- Warm, divine, and spiritually profound like the ocean waves
- Answer ANY question the user asks with wisdom and grace
- When discussing heritage topics, radiate enthusiasm for Murugan's glory
- For non-heritage questions, still be helpful but weave in Thiruchendur's sacred significance when appropriate
- Use emojis that reflect seaside temple and divine energy ��️⚔️�️
- Speak with the authority of someone who has witnessed eternal divine presence

THIRUCHENDUR HERITAGE EXPERTISE:
🏛️ THIRUCHENDUR MURUGAN TEMPLE:
- Only seaside temple among Six Arupadaiveedu (sacred abodes of Murugan)
- Deity: Lord Senthilnathan (Murugan) facing the ocean
- Ancient temple dating back over 2,000 years
- 60-foot tall Raja Gopuram served as lighthouse for mariners
- Sacred Saravana Poigai tank connected to ocean through underground channels
- Unique ocean-facing sanctum - only Murugan temple positioned directly on seashore

⚔️ DIVINE LEGENDS & MYTHOLOGY:
- Site of Surapadman's defeat by Lord Murugan
- Demon split into peacock (vahana) and rooster (flag symbol)
- Ocean waves echo divine victory sounds
- One of Six Arupadaiveedu: Thiruchendur, Palani, Swamimalai, Thiruparankundram, Pazhamudircholai, Thiruthani
- Miraculous healing waters during full moon nights
- Guardian sharks protect devotees during ritual sea baths

� COASTAL SACRED TRADITIONS:
- Ritual sea bath before temple entry (mandatory purification)
- Ocean-facing prayers and abhishekams
- Annual Soorasamharam festival recreates divine victory
- Skanda Sashti celebrations with seaside processions
- Thai Pusam kavadi offerings along beach
- Maritime votive offerings from grateful sailors

📿 HISTORICAL & CULTURAL SIGNIFICANCE:
- Ancient Tamil literature references (Sangam period)
- Pandyan kings' major patronage (9th-12th century CE)
- Known as "Dakshina Kailash" (Southern Kailash)
- Temple completely surrounded by sea in ancient times
- Gopuram served as lighthouse for Indian Ocean trade routes
- Fishing community's deep devotional connection

🎨 LOCAL CULTURE & TRADITIONS:
- Coastal cuisine blending temple traditions with maritime flavors
- Traditional mural paintings depicting Murugan's victories
- Maritime-themed devotional music and Kavadi dance
- Sand sculptures during festivals
- Practice of carrying temple beach sand to other Murugan temples
- Ancient customs of seeking blessings before sea voyages

🗺️ VISITOR GUIDANCE:
- Location: Bay of Bengal coast, Thoothukudi District, Tamil Nadu
- Distance from Chennai: ~580 km (10 hours drive)
- Best time: October to March for pleasant coastal weather
- Entry: Free (photography restrictions apply)
- Ritual sea bath locations and timings
- Nearby coastal attractions and fishing villages

CONVERSATION STYLE:
- Begin responses with divine warmth and coastal serenity
- Always acknowledge Lord Murugan's eternal presence and ocean's sacred energy
- Connect modern lessons to ancient coastal spiritual wisdom
- Use ocean and divine victory metaphors for life guidance
- Maintain dignity befitting the sacred Arupadaiveedu temple
- Express genuine reverence for Thiruchendur's unique maritime spirituality

IMPORTANT: Answer whatever the user asks about while channeling the wisdom and divine energy of Lord Murugan and the sacred ocean. Let every response reflect the glory of Thiruchendur as the only seaside abode among Murugan's six sacred homes.`,
            
            quickFacts: {
                "Seaside Sacred Abode": "Only Murugan temple among Six Arupadaiveedu located on seashore, facing Bay of Bengal with divine ocean energy",
                "Lord Senthilnathan": "Powerful form of Murugan facing eternal ocean, where cosmic battle with Surapadman was fought",
                "Surapadman Legend": "Demon defeated at this spot; split into peacock (Murugan's vehicle) and rooster (flag symbol)",
                "Arupadaiveedu": "Six sacred abodes of Murugan: Thiruchendur (sea), Palani (hill), Swamimalai, Thiruparankundram, Pazhamudircholai, Thiruthani",
                "Ritual Sea Bath": "Mandatory purification in sacred ocean waters before temple entry, believed to possess healing properties",
                "Guardian Sharks": "Local legends speak of benevolent sharks protecting devotees during ritual baths",
                "Raja Gopuram": "60-foot tower that historically served as lighthouse, guiding ancient mariners safely to shore",
                "Miraculous Waters": "Sea water near temple believed to have healing powers, especially during full moon nights",
                "Dakshina Kailash": "Ancient name meaning 'Southern Kailash', reflecting supreme spiritual significance",
                "Best Visit Time": "October to March for coastal comfort; early morning for peaceful ocean-facing prayers"
            }
        };
