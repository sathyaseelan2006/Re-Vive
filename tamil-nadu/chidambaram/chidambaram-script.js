...
function startStory(storyType) {
    ...
    if (!window._chidambaram_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._chidambaram_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._chidambaram_story_options_html) {
        modalBody.innerHTML = window._chidambaram_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('chidambaram_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('chidambaram_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('chidambaram_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('chidambaram_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Chidambaram-specific quiz questions
let quizQuestions = [
    {
        question: "The Chidambaram Temple is dedicated to which form of Lord Shiva?",
        options: ["Linga", "Nataraja (Cosmic Dancer)", "Dakshinamurti", "Ardhanarishvara"],
        correct: 1,
        explanation: "The Chidambaram Temple is dedicated to Lord Shiva as Nataraja, performing the cosmic dance of creation and destruction (Ananda Tandavam)."
    },
    {
        question: "What is unique about the main deity in Chidambaram Temple?",
        options: ["It's made of gold", "It's invisible (Chidambara Rahasyam)", "It's the largest Shiva lingam", "It changes colors"],
        correct: 1,
        explanation: "The sanctum sanctorum has an empty space representing formless space, known as Chidambara Rahasyam (the Secret of Chidambaram)."
    },
    {
        question: "How many golden-roofed halls does Chidambaram Temple have?",
        options: ["Two", "Three", "Four", "Five"],
        correct: 3,
        explanation: "The temple has five sabhas (halls) representing the five cosmic acts of Shiva: creation, preservation, destruction, veiling, and grace."
    },
    {
        question: "Which traditional community has hereditary rights to conduct rituals in Chidambaram Temple?",
        options: ["Dikshitars", "Acharyas", "Pandarams", "Oduvar"],
        correct: 0,
        explanation: "The Dikshitar community has hereditary rights to worship and manage the temple rituals for centuries."
    },
    {
        question: "Chidambaram is one of the Pancha Bootha Sthalams. Which element does it represent?",
        options: ["Earth", "Water", "Fire", "Air", "Space/Ether"],
        correct: 4,
        explanation: "Chidambaram represents Akasha (Space/Ether), symbolizing the formless, all-pervading cosmic consciousness."
    },
    {
        question: "What is the architectural style of Chidambaram Temple's roof?",
        options: ["Stone dome", "Golden tiles (Pon Ambalam)", "Copper plates", "Thatched roof"],
        correct: 1,
        explanation: "The famous golden roof (Pon Ambalam or Kanaka Sabha) is covered with 21,600 golden tiles representing 21,600 breaths a human takes daily."
    },
    {
        question: "Which saint-poets among the Nayanmars are closely associated with Chidambaram?",
        options: ["Appar and Sambandar", "Sundarar and Manikkavasagar", "Thirugnanasambandar and Karaikal Ammaiyar", "All of the above"],
        correct: 3,
        explanation: "All 63 Nayanmars have sung about Chidambaram, with Appar, Sambandar, and Sundarar composing numerous Tevaram hymns."
    },
    {
        question: "What is the significance of the 108 poses (karanas) depicted in Chidambaram?",
        options: ["Dance postures from Natya Shastra", "Yoga poses", "Battle stances", "Meditation positions"],
        correct: 0,
        explanation: "The temple walls depict 108 karanas (dance poses) from Bharata's Natya Shastra, making it a sculptural encyclopedia of classical dance."
    },
    {
        question: "Which important festival celebrates Shiva's cosmic dance at Chidambaram?",
        options: ["Mahashivaratri", "Arudra Darshan (Thiruvadhirai)", "Aani Thirumanjanam", "Panguni Uthiram"],
        correct: 1,
        explanation: "Arudra Darshan (Thiruvadhirai) in December-January is the most important festival, celebrating Nataraja's cosmic dance."
    },
    {
        question: "What does the name 'Chidambaram' mean?",
        options: ["Golden Hall", "Dance Hall", "Atmosphere of Wisdom/Consciousness", "Cosmic Center"],
        correct: 2,
        explanation: "'Chidambaram' means 'atmosphere of wisdom' or 'consciousness-filled space' (Chit = consciousness, Ambaram = atmosphere)."
    },
    {
        question: "The Chidambaram Temple complex covers approximately how many acres?",
        options: ["20 acres", "30 acres", "40 acres", "50 acres"],
        correct: 2,
        explanation: "The vast Chidambaram Temple complex spans approximately 40 acres with four towering gopurams and numerous shrines."
    },
    {
        question: "Which goddess has a prominent shrine in Chidambaram Temple?",
        options: ["Parvati", "Sivakami (Shivakamasundari)", "Meenakshi", "Kamakshi"],
        correct: 1,
        explanation: "Goddess Sivakami (Shivakamasundari) has a major shrine, representing the divine consort who witnessed Shiva's cosmic dance."
    }
];
