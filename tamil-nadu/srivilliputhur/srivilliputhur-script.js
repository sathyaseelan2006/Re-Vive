...
function startStory(storyType) {
    ...
    if (!window._srivilliputhur_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._srivilliputhur_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._srivilliputhur_story_options_html) {
        modalBody.innerHTML = window._srivilliputhur_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('srivilliputhur_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('srivilliputhur_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('srivilliputhur_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('srivilliputhur_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Srivilliputhur-specific quiz questions
let quizQuestions = [
    {
        question: "The temple tower (gopuram) of Srivilliputhur appears on which official symbol?",
        options: ["Indian Currency", "Tamil Nadu Government Emblem", "UNESCO Logo", "Tourism Logo"],
        correct: 1,
        explanation: "The 192-feet tall Rajagopuram of Srivilliputhur Andal Temple is featured on the official emblem of Tamil Nadu Government."
    },
    {
        question: "Srivilliputhur is the birthplace of which Alwar saint?",
        options: ["Thirumazhisai Alwar", "Andal (Kodhai)", "Periyalwar", "Nammalwar"],
        correct: 1,
        explanation: "Andal (Goda/Kodhai), the only female Alwar among the 12 Alvars, was born in Srivilliputhur in the 8th century CE."
    },
    {
        question: "What is unique about Andal among the 12 Alvars?",
        options: ["Youngest Alwar", "Only female Alwar", "Composed most hymns", "Royal birth"],
        correct: 1,
        explanation: "Andal is the only female among the 12 Alvars and is considered an incarnation of Goddess Lakshmi herself."
    },
    {
        question: "How many verses did Andal compose in Tamil?",
        options: ["100", "143", "200", "300"],
        correct: 1,
        explanation: "Andal composed 143 verses: 30 in Thiruppavai and 113 in Nachiyar Thirumozhi, which are part of the Nalayira Divya Prabandham."
    },
    {
        question: "Who was Andal's foster father?",
        options: ["Nammalwar", "Periyalwar (Vishnuchittar)", "Thirumazhisai Alwar", "Thirumangai Alwar"],
        correct: 1,
        explanation: "Periyalwar (Vishnuchittar) found baby Andal in a tulsi garden and raised her as his daughter."
    },
    {
        question: "During which festival month is Andal's Thiruppavai recited?",
        options: ["Thai", "Margazhi (December-January)", "Chithirai", "Aadi"],
        correct: 1,
        explanation: "Thiruppavai, Andal's devotional hymns, are recited daily during the Tamil month of Margazhi (Dhanur Masam)."
    },
    {
        question: "What height is the Rajagopuram of Srivilliputhur Andal Temple?",
        options: ["150 feet", "175 feet", "192 feet", "210 feet"],
        correct: 2,
        explanation: "The 11-tiered Rajagopuram stands at 192 feet (58.5 meters), making it one of the tallest temple towers in Tamil Nadu."
    },
    {
        question: "Which Pandya king built the towering gopuram?",
        options: ["Sundara Pandya", "Jatavarman Sundara Pandyan I", "Maravarman Sundara Pandyan", "Kulasekhara Pandyan"],
        correct: 1,
        explanation: "Jatavarman Sundara Pandyan I built the magnificent gopuram in the 13th century CE."
    },
    {
        question: "The temple is one of the 108 what?",
        options: ["Shiva temples", "Divya Desams (Vishnu temples)", "Shakti Peethas", "Jyotirlingas"],
        correct: 1,
        explanation: "Srivilliputhur is one of the 108 Divya Desams, the sacred Vishnu temples sung about by the Alwars."
    },
    {
        question: "According to legend, Andal wore a garland intended for whom?",
        options: ["Her father", "The temple deity", "Lord Ranganatha", "Village elders"],
        correct: 2,
        explanation: "Young Andal secretly wore the garland meant for the deity, and Lord Ranganatha later requested only garlands worn by her."
    },
    {
        question: "Which temple did Andal eventually merge with the deity?",
        options: ["Madurai Meenakshi Temple", "Srirangam Ranganathaswamy Temple", "Tirupati Temple", "Srivilliputhur Temple"],
        correct: 1,
        explanation: "According to legend, Andal merged with Lord Ranganatha at Srirangam Temple, symbolizing her union with the divine."
    },
    {
        question: "What is the sacred tank at Srivilliputhur called?",
        options: ["Andal Kulam", "Sarovar Theertham", "Vatapatrasayi", "Periyalwar Pushkarini"],
        correct: 2,
        explanation: "The sacred temple tank is called Vatapatrasayi (Vatapatrasayee Pushkarini), believed to have divine properties."
    }
];
