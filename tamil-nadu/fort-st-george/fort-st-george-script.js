...
function startStory(storyType) {
    ...
    if (!window._fort_st_george_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._fort_st_george_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._fort_st_george_story_options_html) {
        modalBody.innerHTML = window._fort_st_george_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('fort-st-george_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('fort-st-george_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('fort-st-george_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('fort-st-george_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Fort St. George-specific quiz questions
let quizQuestions = [
    {
        question: "In which year was Fort St. George established by the British East India Company?",
        options: ["1639", "1644", "1650", "1665"],
        correct: 0,
        explanation: "Fort St. George was established on April 23, 1639, making it the first English fortress in India."
    },
    {
        question: "Who was the British administrator who purchased the land for Fort St. George?",
        options: ["Robert Clive", "Francis Day", "Warren Hastings", "Thomas Munro"],
        correct: 1,
        explanation: "Francis Day, a factor of the British East India Company, negotiated with the Nayak of Vandavasi to acquire the land."
    },
    {
        question: "The fort is named after which saint?",
        options: ["St. Thomas", "St. Peter", "St. George", "St. Paul"],
        correct: 2,
        explanation: "The fort is named after St. George, the patron saint of England, as it was built on St. George's Day (April 23)."
    },
    {
        question: "Which important government building is currently housed within Fort St. George?",
        options: ["Governor's Office", "Tamil Nadu Legislative Assembly", "High Court", "Municipal Corporation"],
        correct: 1,
        explanation: "Fort St. George currently houses the Tamil Nadu Legislative Assembly and Secretariat, the administrative headquarters."
    },
    {
        question: "What is the name of the museum located within Fort St. George?",
        options: ["British Museum", "Fort Museum", "Colonial Heritage Museum", "Chennai Museum"],
        correct: 1,
        explanation: "The Fort Museum displays artifacts from the British and French colonial periods, including weapons, coins, and documents."
    },
    {
        question: "Which church is one of the oldest British churches in India, located within the fort?",
        options: ["St. George Cathedral", "St. Mary's Church", "St. Thomas Church", "Holy Trinity Church"],
        correct: 1,
        explanation: "St. Mary's Church, built in 1680, is the oldest British church in India and is located within Fort St. George."
    },
    {
        question: "Who among these British governors is buried at St. Mary's Church in the fort?",
        options: ["Warren Hastings", "Elihu Yale (founder of Yale University)", "Lord Cornwallis", "Robert Clive"],
        correct: 1,
        explanation: "Elihu Yale, who later became the benefactor of Yale University, served as a governor and is buried at St. Mary's Church."
    },
    {
        question: "The fort was briefly captured by which French commander in 1746?",
        options: ["Joseph François Dupleix", "Marquis de Bussy-Castelnau", "Bertrand-François Mahé de La Bourdonnais", "Pierre André de Suffren"],
        correct: 2,
        explanation: "French Admiral La Bourdonnais captured Fort St. George in 1746 during the First Carnatic War."
    },
    {
        question: "What architectural style is predominantly seen in Fort St. George?",
        options: ["Gothic", "Indo-Saracenic", "British Colonial", "Baroque"],
        correct: 2,
        explanation: "The fort exemplifies British Colonial architecture with its fortifications, military structures, and administrative buildings."
    },
    {
        question: "The flagstaff inside the fort is approximately how tall?",
        options: ["100 feet", "120 feet", "150 feet", "180 feet"],
        correct: 2,
        explanation: "The flagstaff is about 150 feet tall and is one of the tallest in India, symbolizing British colonial power."
    },
    {
        question: "Which famous battle was fought nearby, affecting the control of Fort St. George?",
        options: ["Battle of Plassey", "Battle of Wandiwash", "Battle of Arcot", "Battle of Buxar"],
        correct: 1,
        explanation: "The Battle of Wandiwash (1760) between British and French forces ultimately secured British control over Fort St. George."
    },
    {
        question: "What was Fort St. George's original purpose?",
        options: ["Military fortress only", "Trading post and fortress", "Administrative center", "Residential colony"],
        correct: 1,
        explanation: "Fort St. George served both as a trading post for the East India Company and as a defensive fortress against European rivals."
    }
];
