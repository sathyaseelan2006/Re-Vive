...
function startStory(storyType) {
    ...
    if (!window._kanchipuram_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._kanchipuram_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._kanchipuram_story_options_html) {
        modalBody.innerHTML = window._kanchipuram_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('kanchipuram_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('kanchipuram_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('kanchipuram_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('kanchipuram_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let score = 0;
// Kanchipuram-specific quiz questions
let quizQuestions = [
    {
        question: "Kanchipuram is known as the 'City of' what?",
        options: ["Thousand Temples", "Golden Temples", "Ancient Temples", "Seven Temples"],
        correct: 0,
        explanation: "Kanchipuram is famous as the 'City of Thousand Temples' with over 1000 temples showcasing Pallava and Chola architecture."
    },
    {
        question: "Which dynasty primarily developed Kanchipuram as their capital?",
        options: ["Chola dynasty", "Pandya dynasty", "Pallava dynasty", "Vijayanagara dynasty"],
        correct: 2,
        explanation: "The Pallava dynasty ruled from Kanchipuram from the 3rd to 9th century CE, creating magnificent architectural masterpieces."
    },
    {
        question: "The Kailasanathar Temple was built by which Pallava king?",
        options: ["Mahendravarman I", "Narasimhavarman I", "Rajasimha", "Nandivarman II"],
        correct: 2,
        explanation: "Rajasimha (Narasimhavarman II) built the Kailasanathar Temple in the early 8th century CE, the oldest structure in Kanchipuram."
    },
    {
        question: "Kanchipuram is one of the seven sacred cities (Sapta Puri) in which religion?",
        options: ["Buddhism", "Jainism", "Hinduism", "Sikhism"],
        correct: 2,
        explanation: "Kanchipuram is one of the seven Sapta Puri (sacred cities) in Hinduism, believed to grant moksha (liberation)."
    },
    {
        question: "What is Kanchipuram traditionally famous for producing?",
        options: ["Bronze sculptures", "Silk sarees", "Stone carvings", "Temple jewelry"],
        correct: 1,
        explanation: "Kanchipuram silk sarees are world-renowned for their quality, durability, and rich golden borders with intricate designs."
    },
    {
        question: "The Ekambareswarar Temple is dedicated to which deity?",
        options: ["Vishnu", "Shiva", "Brahma", "Murugan"],
        correct: 1,
        explanation: "The Ekambareswarar Temple is dedicated to Lord Shiva and features one of the tallest gopurams in Tamil Nadu."
    },
    {
        question: "Which Chinese traveler visited Kanchipuram in the 7th century?",
        options: ["Fa-Hien", "Xuanzang (Hiuen Tsang)", "I-Tsing", "Faxian"],
        correct: 1,
        explanation: "Xuanzang (Hiuen Tsang) visited Kanchipuram in the 7th century and documented its Buddhist monasteries and prosperity."
    },
    {
        question: "How many major temples are considered the Pancha Bootha Sthalams in Kanchipuram?",
        options: ["One", "Two", "Three", "Five"],
        correct: 0,
        explanation: "The Ekambareswarar Temple represents the Earth element among the Pancha Bootha Sthalams (five element temples)."
    },
    {
        question: "The Varadharaja Perumal Temple is dedicated to which deity?",
        options: ["Shiva", "Vishnu", "Brahma", "Ganesha"],
        correct: 1,
        explanation: "The Varadharaja Perumal Temple is one of the 108 Divya Desams dedicated to Lord Vishnu."
    },
    {
        question: "What architectural style are Kanchipuram temples primarily known for?",
        options: ["Dravidian architecture", "Indo-Islamic architecture", "Vesara architecture", "Nagara architecture"],
        correct: 0,
        explanation: "Kanchipuram temples exemplify Dravidian architecture with their towering gopurams, pillared halls, and intricate carvings."
    },
    {
        question: "The sacred mango tree in Ekambareswarar Temple is believed to be how old?",
        options: ["500 years", "1000 years", "2500 years", "3500 years"],
        correct: 3,
        explanation: "The sacred mango tree in the temple is believed to be over 3500 years old, making it one of the oldest living trees."
    },
    {
        question: "Which goddess is primarily worshipped at the Kamakshi Amman Temple?",
        options: ["Parvati", "Kamakshi", "Meenakshi", "Lalitha"],
        correct: 1,
        explanation: "Goddess Kamakshi, a form of Parvati, is the presiding deity of the Kamakshi Amman Temple, one of the 51 Shakti Peethas."
    }
];
