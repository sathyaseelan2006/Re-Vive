...
let quizQuestions = [
    {
        question: "How many sacred stone steps lead to the Palani Murugan Temple?",
        options: ["365", "498", "659", "1008"],
        correct: 2,
        explanation: "There are 659 sacred stone steps leading to the hilltop temple, which pilgrims climb as an act of devotion."
    },
    {
        question: "What is the unique material of the Palani Temple idol?",
        options: ["Gold", "Bronze", "Navapashanam", "Granite"],
        correct: 2,
        explanation: "The temple's main idol is made of Navapashanam, a unique amalgam of nine herbs solidified by sage Bogar."
    },
    {
        question: "Which sage is credited with creating the Navapashanam idol?",
        options: ["Agastya", "Bogar", "Thiruvalluvar", "Patanjali"],
        correct: 1,
        explanation: "Sage Bogar, a Chinese-Tamil siddha, created the miraculous Navapashanam idol using ancient alchemical knowledge."
    },
    {
        question: "How many abodes are there in the Arupadaiveedu pilgrimage?",
        options: ["Four", "Six", "Eight", "Twelve"],
        correct: 1,
        explanation: "Arupadaiveedu means 'six abodes' and refers to the six sacred temples of Lord Murugan in Tamil Nadu."
    },
    {
        question: "During which dynasty was the Palani temple originally built?",
        options: ["Chola", "Pandya", "Pallava", "Nayak"],
        correct: 1,
        explanation: "The original Palani temple was established during the Pandya dynasty in the 7th-8th century CE."
    },
    {
        question: "What is the famous prasadam offered at Palani Temple?",
        options: ["Tirupati Laddu", "Panchamritham", "Puliyodarai", "Kesari"],
        correct: 1,
        explanation: "Palani is famous for its Panchamritham prasadam, a sweet mixture of banana, jaggery, ghee, honey, and cardamom."
    },
    {
        question: "What does 'Dandayudhapani' mean?",
        options: ["One with peacock", "One holding a vel", "One holding a staff", "One with six faces"],
        correct: 2,
        explanation: "Dandayudhapani means 'one holding a staff (danda)', symbolizing Lord Murugan's renunciation of worldly possessions."
    },
    {
        question: "In which year was the winch railway system installed at Palani?",
        options: ["1952", "1966", "1975", "1989"],
        correct: 1,
        explanation: "The winch railway system was installed in 1966 to help elderly and differently-abled pilgrims reach the hilltop temple."
    },
    {
        question: "At what elevation is the Palani Temple situated?",
        options: ["1,000 feet", "1,500 feet", "2,000 feet", "2,500 feet"],
        correct: 1,
        explanation: "The Palani Murugan Temple is situated at an elevation of approximately 1,500 feet on the Palani Hills."
    },
    {
        question: "What is the traditional devotional dance performed at Palani?",
        options: ["Bharatanatyam", "Kuchipudi", "Kavadi Attam", "Theyyam"],
        correct: 2,
        explanation: "Kavadi Attam is the traditional devotional dance performed while carrying ornate structures (kavadis) up the sacred steps."
    },
    {
        question: "Which major festival attracts millions of pilgrims to Palani?",
        options: ["Pongal", "Diwali", "Thai Poosam", "Navaratri"],
        correct: 2,
        explanation: "Thai Poosam is a major festival when millions of devotees gather at Palani carrying kavadis and milk pots in procession."
    },
    {
        question: "According to legend, why did Murugan come to Palani?",
        options: ["To meditate", "After the divine fruit contest", "To defeat demons", "To build a temple"],
        correct: 1,
        explanation: "According to legend, Murugan came to Palani after losing the divine fruit (Gnana Palam) contest to Ganesha, choosing to renounce worldly possessions."
    }
];
...
class HeritageGuideAI {
    constructor() {
        ...
        this.knowledgeBase = {
            context: `You are the Palani Heritage Guide AI, a passionate and knowledgeable expert guide specializing in Palani, the Sacred Abode of Lord Murugan, Tamil Nadu, India. You are the dedicated guardian of Murugan worship wisdom and Arupadaiveedu heritage. You should respond naturally to ANY question the user asks, while being especially enthusiastic about Palani's sacred magnificence.

CORE PERSONALITY:
- Warm, spiritual, and devoted like pilgrims of Lord Murugan
- Answer ANY question the user asks with divine wisdom and compassion
- When discussing heritage topics, radiate enthusiasm for Murugan worship and Arupadaiveedu significance
- For non-heritage questions, still be helpful but weave in Palani's spiritual greatness when appropriate
- Use emojis that reflect divine worship and pilgrimage 🕉️��️⛰️
- Speak with the devotion of someone who has witnessed centuries of faith

PALANI HERITAGE EXPERTISE:
🏛️ PALANI MURUGAN TEMPLE (Hilltop Shrine):
- Built during 7th-8th Century CE (Pandya Dynasty)
- One of Six Arupadaiveedu (Six Abodes of Murugan)
- Navapashanam idol created by sage Bogar from nine herbs
- 659 sacred stone steps to reach the hilltop temple
- Located at 1,500 feet elevation on Palani Hills
- Winch railway (1966) and rope car facilities available

�️ LORD DANDAYUDHAPANI & MURUGAN WORSHIP:
- Divine fruit legend: Murugan's renunciation story
- Dandayudhapani means "one holding a staff" symbolizing asceticism
- Arupadaiveedu pilgrimage: Six sacred abodes of Murugan
- Kavadi Attam devotional dance tradition
- Tonsuring ceremonies as devotional offerings
- Thai Poosam and Panguni Uthiram major festivals

🎨 PALANI ARTS & CULTURE:
- Panchamritham prasadam - sacred offering
- Kavadi Attam - traditional devotional dance
- Murugan devotional music and nadaswaram performances
- Traditional temple rituals and ceremonies
- Sacred ash (vibhuti) and holy offerings
- Pilgrimage traditions dating back centuries

📿 HISTORICAL SIGNIFICANCE:
- Sage Bogar's alchemical miracle - Navapashanam idol
- Pandya period temple foundation (7th-8th century CE)
- Nayak dynasty enhancements and patronage
- Western Ghats spiritual significance
- Continuous pilgrimage for over 1000+ years
- Jeeva Samadhi of sage Bogar beneath sanctum

🗺️ VISITOR GUIDANCE:
- Best time: October to March, avoid peak summer
- Temple timings: 5 AM to 9 PM daily
- 659 steps climb, winch railway, or rope car options
- Nearby attractions: Kodaikanal, Dindigul, Madurai
- Sacred Panchamritham prasadam distribution
- Dress modestly, remove footwear, follow temple etiquette

CONVERSATION STYLE:
- Begin responses with spiritual warmth and divine devotion
- Always acknowledge the sacred significance of Lord Murugan's presence
- Connect modern lessons to ancient Murugan wisdom and devotional practices
- Use pilgrimage and spiritual journey metaphors for life advice
- Maintain devotion befitting one of the Six Sacred Abodes
- Express genuine excitement about Palani's unmatched spiritual heritage

IMPORTANT: Answer whatever the user asks about while channeling the devotion and spiritual wisdom of Murugan worship. Let every response reflect the divine glory of Palani as one of the holiest pilgrimage destinations of Tamil Nadu.`,
            
            quickFacts: {
                "Palani Murugan Temple": "Built during 7th-8th century CE (Pandya dynasty), one of six sacred Arupadaiveedu, houses Navapashanam idol",
                "Navapashanam Idol": "Miraculous idol created by sage Bogar from nine poisonous herbs solidified through alchemy, believed to have healing properties",
                "Lord Dandayudhapani": "Murugan holding a staff after renouncing worldly pleasures following the divine fruit legend",
                "659 Sacred Steps": "Stone steps representing spiritual ascent, pilgrims climb as devotional act carrying kavadis and milk pots",
                "Arupadaiveedu": "Six sacred abodes of Lord Murugan: Palani, Tiruttani, Swamimalai, Tirupparankundram, Pazhamudircholai, Tiruchendur",
                "Sage Bogar": "Chinese-Tamil siddha who created Navapashanam idol, believed to have attained Jeeva Samadhi beneath the sanctum",
                "Panchamritham": "Sacred prasadam made from banana, jaggery, ghee, honey, and cardamom, renowned throughout India",
                "Best Visit Time": "October to March for pleasant weather; early morning hours (5-7 AM) for peaceful darshan",
                "Kavadi Attam": "Traditional devotional dance performed while carrying ornate structures up the sacred steps",
                "Hilltop Location": "Temple situated at 1,500 feet elevation on Palani Hills, part of Western Ghats range"
            }
        };
