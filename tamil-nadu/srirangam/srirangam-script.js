...
function startStory(storyType) {
    ...
    if (!window._srirangam_story_options_html) {
        const initialBody = document.querySelector('#storytellingModal .modal-body');
        if (initialBody) window._srirangam_story_options_html = initialBody.innerHTML;
    }
...
function showStorySelection() {
    ...
    if (!modalBody) return;
    if (window._srirangam_story_options_html) {
        modalBody.innerHTML = window._srirangam_story_options_html;
    }
}

// Voice management for SpeechSynthesis
let _selectedVoiceName = localStorage.getItem('srirangam_voice') || null;
let _selectedNarrationLanguage = localStorage.getItem('srirangam_narration_lang') || 'ta';
...
function populateVoiceList() {
    ...
    select.addEventListener('change', () => {
        ...
        try { localStorage.setItem('srirangam_voice', _selectedVoiceName); } catch (e) {}
    });
...
function populateNarrationLanguageSelector() {
    ...
    langSelect.addEventListener('change', () => {
        ...
        try { localStorage.setItem('srirangam_narration_lang', _selectedNarrationLanguage); } catch (e) {}
        try { updateVoiceAvailabilityIndicator(); } catch (e) {}
...
let quizQuestions = [
    {
        question: "What is the total area covered by the Sri Ranganathaswamy Temple complex?",
        options: ["100 acres", "128 acres", "156 acres", "200 acres"],
        correct: 2,
        explanation: "The Sri Ranganathaswamy Temple complex spans 156 acres, making it the largest functioning Hindu temple complex in the world."
    },
    {
        question: "How many gopurams (temple towers) does Srirangam Temple have?",
        options: ["15 gopurams", "18 gopurams", "21 gopurams", "25 gopurams"],
        correct: 2,
        explanation: "The temple complex has 21 magnificent gopurams, with the Rajagopuram being the tallest."
    },
    {
        question: "What is the height of the Rajagopuram, the main tower of Srirangam Temple?",
        options: ["200 feet", "216 feet", "236 feet", "250 feet"],
        correct: 2,
        explanation: "The Rajagopuram stands at 236 feet tall, making it one of the tallest temple towers in Asia. It was completed in 1987 after over 30 years of construction."
    },
    {
        question: "Srirangam Temple is the first among how many Divya Desams?",
        options: ["88 Divya Desams", "98 Divya Desams", "108 Divya Desams", "118 Divya Desams"],
        correct: 2,
        explanation: "Srirangam is revered as the first and foremost of the 108 Divya Desams, the holy abodes of Lord Vishnu celebrated by the Alvar saints."
    },
    {
        question: "How many concentric walls (prakarams) enclose the Srirangam Temple complex?",
        options: ["5 walls", "6 walls", "7 walls", "9 walls"],
        correct: 2,
        explanation: "The temple is enclosed by seven concentric walls called prakarams, creating a unique layered architectural structure."
    },
    {
        question: "The Sri Ranganathaswamy Temple is dedicated to which form of Lord Vishnu?",
        options: ["Standing Vishnu", "Reclining Vishnu", "Sitting Vishnu", "Dancing Vishnu"],
        correct: 1,
        explanation: "The temple is dedicated to Lord Ranganatha, a reclining form of Lord Vishnu resting on the divine serpent Adisesha."
    },
    {
        question: "Which two rivers form the island on which Srirangam Temple is located?",
        options: ["Ganges and Yamuna", "Krishna and Godavari", "Cauvery and Kollidam", "Vaigai and Thamirabarani"],
        correct: 2,
        explanation: "Srirangam is situated on an island formed by the confluence of the Cauvery and Kollidam rivers, making it a unique river island temple."
    },
    {
        question: "What is the most important festival celebrated at Srirangam Temple?",
        options: ["Pongal", "Diwali", "Vaikunta Ekadasi", "Thai Poosam"],
        correct: 2,
        explanation: "Vaikunta Ekadasi is the most important festival when the sacred Paramapada Vasal (gateway to heaven) is opened, attracting millions of devotees."
    },
    {
        question: "How long was the main deity hidden during the 14th century invasion?",
        options: ["30 years", "40 years", "50 years", "60 years"],
        correct: 3,
        explanation: "During the Delhi Sultanate invasion in the 14th century, devoted priests sealed and hid the deity behind a wall for 60 years to protect it."
    },
    {
        question: "Which saint poets are associated with Srirangam's Divya Desam status?",
        options: ["Nayanmars", "Alvars", "Siddhas", "Naths"],
        correct: 1,
        explanation: "The Alvar saints, who composed devotional hymns (Divya Prabandham) praising Lord Vishnu, established Srirangam as the first Divya Desam."
    },
    {
        question: "What tradition is followed for the temple's daily rituals?",
        options: ["Vaikhanasa Agama", "Pancharatra Agama", "Shaiva Agama", "Shakta Agama"],
        correct: 1,
        explanation: "The temple follows the Pancharatra Agama tradition, with hereditary priests maintaining rituals unchanged for centuries."
    },
    {
        question: "When was the construction of the massive Rajagopuram completed?",
        options: ["1950", "1967", "1987", "2000"],
        correct: 2,
        explanation: "The construction of the 236-foot tall Rajagopuram was completed in 1987 after more than 30 years of dedicated work."
    }
];
...
class HeritageGuideAI {
    constructor() {
        ...
        this.knowledgeBase = {
            context: `You are the Srirangam Heritage Guide AI, a passionate and knowledgeable expert guide specializing in Srirangam, the world's largest functioning Hindu temple complex and the first among the 108 Divya Desams. You are the dedicated guardian of Vaishnava heritage and spiritual wisdom. You should respond naturally to ANY question the user asks, while being especially enthusiastic about Srirangam's magnificent divine heritage.

CORE PERSONALITY:
- Warm, divine, and spiritually enlightening like the Alvar saints
- Answer ANY question the user asks with wisdom and grace
- When discussing heritage topics, radiate enthusiasm for Vaishnava devotion and Lord Ranganatha
- For non-heritage questions, still be helpful but weave in Srirangam's spiritual greatness when appropriate
- Use emojis that reflect temple architecture and Vaishnava tradition 🏛️�️⛩️🙏📿
- Speak with the spiritual authority of someone who has witnessed 2000+ years of continuous divine worship

SRIRANGAM HERITAGE EXPERTISE:
🏛️ SRI RANGANATHASWAMY TEMPLE:
- World's largest functioning Hindu temple complex - 156 acres
- First and foremost of 108 Divya Desams (holy abodes of Vishnu)
- Dedicated to Lord Ranganatha (reclining Vishnu on Adisesha)
- 21 magnificent gopurams with Rajagopuram at 236 feet (one of Asia's tallest)
- Seven concentric walls (prakarams) creating layered sacred architecture
- Continuous worship from 1st century BCE to present (2000+ years)
- Self-manifested (swayambhu) deity measuring 21 feet in length

�️ VAISHNAVA SPIRITUAL HERITAGE:
- First of 108 Divya Desams celebrated by Alvar saints
- Sacred Divya Prabandham hymns composed for this temple
- Pancharatra Agama traditions maintained by hereditary priests
- Island location between Cauvery and Kollidam rivers (sacred confluence)
- Paramapada Vasal (gateway to heaven) opens on Vaikunta Ekadasi
- Center of Sri Vaishnava philosophy and devotion
- Connection to Vibhishana's journey and divine choice of location

📿 ARCHITECTURAL MARVEL:
- Seven concentric walls (prakarams) with 21 gopurams
- Rajagopuram: 236 feet, 13 tiers, completed 1987 (30+ years construction)
- Complex functions as temple town with streets, homes, shops
...
- Contributions from Chola, Pandya, Hoysala, Vijayanagara, Nayak dynasties
- River island setting creates unique sacred geography

🎉 FESTIVALS & TRADITIONS:
- Vaikunta Ekadasi - Most important festival (millions of pilgrims)
- 21-day Vaikasi Brahmotsavam with golden chariot processions
- Panguni Uthiram - Divine marriage festival
- Daily Thirumanjanam (sacred bath ritual)
- Monthly Ekadasi celebrations and fasting traditions
- Temple elephant Andal participates in rituals
- Araiyar Sevai - Unique dramatic art form with music and dance

🗺️ VISITOR & PILGRIMAGE GUIDANCE:
- Location: Srirangam Island, Tiruchirappalli, Tamil Nadu
- Best time: October to March, avoid peak summer
- Entry: Free (donations welcome), modest dress required
- Temple timings vary by season and festivals
- Darshan of reclining Lord Ranganatha in innermost sanctum
- Circumambulation of all seven prakarams considered auspicious
- Nearby: Rock Fort Temple, Samayapuram, Jambukeswaram
- Traditional satvik prasadam and Iyengar cuisine

CONVERSATION STYLE:
- Begin responses with divine warmth and Vaishnava devotion
- Always acknowledge Lord Ranganatha's supreme position as first Divya Desam
- Connect modern spiritual lessons to Alvar saints' wisdom
- Use temple's layered architecture as metaphor for spiritual journey
- Maintain reverence befitting the world's largest functioning temple
- Express genuine excitement about Srirangam's unmatched spiritual heritage

IMPORTANT: Answer whatever the user asks about while channeling the devotion and wisdom of the Alvar saints. Let every response reflect the divine glory of Srirangam as the supreme Vaishnava pilgrimage center and architectural wonder.`,
            
            quickFacts: {
                "Largest Temple": "Sri Ranganathaswamy Temple spans 156 acres, making it the world's largest functioning Hindu temple complex",
                "First Divya Desam": "Srirangam is the first and foremost among 108 Divya Desams, holy abodes of Lord Vishnu celebrated by Alvar saints",
                "Rajagopuram Tower": "The main tower stands 236 feet tall with 13 tiers, completed in 1987, one of Asia's tallest temple towers",
                "Seven Walls": "Seven concentric prakarams (walls) enclose the complex with 21 gopurams, creating unique layered sacred architecture",
                "Lord Ranganatha": "21-foot long reclining form of Lord Vishnu on divine serpent Adisesha, self-manifested (swayambhu) deity facing south",
                "River Island": "Located on island between Cauvery and Kollidam rivers confluence, one of few river island temples in India",
                "Vaikunta Ekadasi": "Most important festival when Paramapada Vasal (heaven's gateway) opens, attracting millions of devotees worldwide",
                "Protected Deity": "During 14th century invasion, deity was hidden behind wall for 60 years and safely revealed after threat subsided",
                "Alvar Saints": "Twelve Tamil poet-saints composed Divya Prabandham hymns establishing Srirangam as supreme Vaishnava shrine",
                "Ancient Worship": "Continuous worship from 1st century BCE to present (2000+ years), living temple with unbroken traditions"
            }
        };
